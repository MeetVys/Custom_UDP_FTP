"""Localhost sender — reliable file transfer over UDP.
...
WINDOW_SIZE = 200       # concurrent in-flight packets
TIMEOUT     = 0.001     # retransmission interval (seconds)
...
class Sender:
    ...
    def disconnect(self):
        """Perform FIN / FIN-ACK teardown.  Returns True when confirmed."""
